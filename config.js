...
module.exports = {
	VERSION: 'v4.4.1', 
    SESSION_ID: process.env.SESSION_ID || '04_28_H_E_R_M_I_T_2O3BNF6',
    ...
    BOT_INFO: process.env.BOT_INFO || 'ʜᴇʀᴍɪᴛ;ᴀᴅɪᴛʜyᴀɴ;258875835086;https://i.imgur.com/6oRG106.jpeg',
    ...
    HEROKU: {
       ...
       SUDO: process.env.SUDO || '258875835086,0',
       DEBUG: DEBUG
};
